...
public class AmbilWarnaDialog {
     ...
     */
    public AmbilWarnaDialog(final Context context, int color, int style, OnAmbilWarnaListener listener) {
        this(context, color, false, style,listener);
    }
     ...
     * @param listener      an OnAmbilWarnaListener, allowing you to get back error or OK
     */
    public AmbilWarnaDialog(final Context context, int color, boolean supportsAlpha, int style, OnAmbilWarnaListener listener) {
